...
mod message_format_enum_type;
mod message_priority_enum_type;
mod message_state_enum_type;
mod message_trigger_enum_type;
mod mobility_needs_mode_enum_type;
mod monitor_enum_type;
mod monitoring_base_enum_type;
mod monitoring_criterion_enum_type;
mod mutability_enum_type;
mod notify_allowed_energy_transfer_status_enum_type;
mod notify_ev_charging_needs_status_enum_type;
mod ocpp_interface_enum_type;
mod ocpp_transport_enum_type;
mod ocpp_version_enum_type;
mod operational_status_enum_type;
mod operation_mode_enum_type;
mod payment_status_enum_type;
mod phase_enum_type;
mod power_during_cessation_enum_type;
mod preconditioning_status_enum_type;
mod priority_charging_status_enum_type;
mod published_firmware_status_enum_type;
mod reading_context_enum_type;
mod reason_enum_type;
mod recurrency_kind_enum_type;
mod registration_status_enum_type;
mod report_base_enum_type;
mod requested_start_stop_status_enum_type;
mod reservation_update_status_enum_type;
mod reserve_now_status_enum_type;
mod reset_enum_type;
mod reset_status_enum_type;
mod send_local_list_status_enum_type;
mod set_monitoring_status_enum_type;
mod set_network_profile_status_enum_type;
mod set_variable_status_enum_type;
mod tariff_change_status_enum_type;
mod tariff_clear_status_enum_type;
mod tariff_cost_enum_type;
